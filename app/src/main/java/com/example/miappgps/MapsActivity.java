...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        googleMap.setMyLocationEnabled(true); //punto azul de ubicacion
        googleMap.getUiSettings().setMapToolbarEnabled(false); //indicaciones y maps
        googleMap.getUiSettings().setCompassEnabled(false); //brujula
        googleMap.getUiSettings().setMyLocationButtonEnabled(false); //mi ubicacion
        */
